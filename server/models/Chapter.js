...
// A chapter, in our data structure, is a snippet of story narrative which describes a plot point and prompts the user to select a choice based on the action in the story. (Or, the chapter simply concludes the story if the chapter's isEnd property is true.)
const chapterSchema = new Schema(
  {
    ...
    choices: {
      ...
      validate: {
        ...
        // Validator message for the number of choices.
